...
#
#   > newDataFrame <- field_metrics(myDataFrame)
#
# Step 5: Write output to a file named "myFile". The output can 
#         then be loaded into MS Excel (or other program) for 
#         review.
#
#   > write.table(newDataFrame, file="myFile", sep="|", na="", quote=F, row.names=F, col.names=T)
#
#==============================================================
